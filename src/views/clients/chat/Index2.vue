  ...
  <div>
    <div class="row no-gutters">
      ...
      <div class="col-md-8">
        ...
        <div class="chat-panel" style="height:600px; overflow-y: auto;">
          
          <div v-for="item in chatMessages" class="row no-gutters">
            <img :class="item.UserID == user?'profile-image float-left':'profile-image float-right'" src="../../../assets/user2-160x160.jpg" alt />
            <div :class="item.UserID == user?'col-md-3 offset-md-9':'col-md-3'">
               <div :class="item.UserID == user? 'chat-bubble chat-bubble--right':'chat-bubble chat-bubble--left'">{{item.Message}}</div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    sendToGroup() {
      ...
      //  <div class="row no-gutters">
      //       <div class="col-md-3">
      //         <div class="chat-bubble chat-bubble--left">${self.message}</div>
      //       </div>
      //     </div>
      // `;
